...
class ColorHelper
{
    ...
    public static function getCssColorFromValue(string $value): string
    {
        $color = $value;

        if (preg_match('#^[A-Fa-f\d]{3,8}$#', $color)) {
            $color = '#' . $color;
        }
    ...
    /**
     * @param iterable|ColorModel[] $colorCollection
     * @return string
     */
